  ...
  unionPay.prototype = {
    ...
    initEvent : function(){
      ...
      $('.detail_more_ctl .show').click(function(){
        var $this = $(this), spans = $this.find('span');
        var prtCtl = $this.parents('.detail_more_ctl').siblings('.pay_count');
        var payDetailCount = $('#pay_count_detail');
        prtCtl.toggle();
        payDetailCount.toggle();
    ...
    securityControl:function(ctl, radioEle, callback){
      ...
      var updateCardInfoData = function(){
          me.cardInfoData['bankCode'] = radioEle.attr('bankCode');;
          me.cardInfoData['channel'] = radioEle.attr('channel');;
          me.cardInfoData['tppCode'] = radioEle.attr('tppCode');;
          me.cardInfoData['isDirect'] = radioEle.attr('isDirect');;
      }
      if(!ctl){
    ...
    initTimeCount : function(){
      ...
      var timeout=function(){
        window.location.href= me.errorUrl;
      };
    ...
    showOtherBankDialog:function(){
      ...
      this.otherBankDlg = new QNR.htmlDialog(html);
      this.otherBankDlg.show();
      ...
      $(".b_other_bank .close").one("click",function(){
        ...
        $wrap.find(".content_wrap form").children().appendTo(quickPayForm);
        allcardsCon.hide();
