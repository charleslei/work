  ...
  unionPay.prototype = {
    ...
    initEvent : function(){
      ...
      $("#credit_cardnum, #debit_cardnum").bind("keyup change focus", function() {
        var _self = $(this), text = _self.val(), value;
        if (text) {
    ...
    getParam : function(){
      var me = this, parm = me.getForm(payForm);
      return parm;
    },
    ...
    checkDateEnable: function(){
      ...
      var dd = date.match(/\d{2}/g);
      var y = dd[0], m = dd[1];
      var dateNow = new Date();
      var y0 = dateNow.getFullYear().toString().match(/\d{2}/g)[1];
      var m0 = dateNow.getMonth() + 1;
      var yEle = bindcardsCon.find('.expires_year');
      var mEle = bindcardsCon.find('.expires_month');
