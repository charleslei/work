	...
	creditCardDialog : ['<div class="b_fpanel bank_width b_chose_bank">',
									'<div class="container">',
										'<div class="inner inner1 b_tab_ui">',
											...
											'<div class="content_wrap b_bank_list debit_card">',
												'<form name="quickpayform" class="quickpayform" id="quickpayform" action="${usuallyCardpayUrl}" method="post" target="_blank">',
												  ...
												  '<table>',
													...
													'</tr>',
												  '</tbody></table>',
												  '<div class="e_ops_button e_ops_button1"><button class="btn_submit" id="btnCreditSubmit_next" type="button">下一步</button><span>跳转至银行页面完成付款</span></div>',
												'</form>',
											'</div>',
										'</div>',
									'</div>',
