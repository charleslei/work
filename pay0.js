...
var quickPayTemplate = {
	...
	creditCardDialog : ['<div class="b_fpanel bank_width b_chose_bank">',
									...
									'</div>',
								'</div>'],
	payDoneDialog : ['<div class="b_fpanel">',
									'<div class="container payResult">',
										'<div class="inner">',
											'<div class="e_title"><span class="title_txt">支付结果</span></div>',
											'<div class="content_wrap">',
												'<div><a href="#">支付成功</a><a href="#">支付失败，继续支付</a></div>',
												'<div>',
													'<p>问题解答</p>',
													'<p>1. 网上银行页面打不开，或者打开无法支付，怎么办？ <a href="#">查看</a></p>',
													'<p>2. 网上银行已经扣款，但是没有给您提示付款成功信息？ <a href="#">查看</a></p>',
													'<p>3. 我网上银行重复多次付款怎么办？ <a href="#">查看</a></p>',
												'</div>',
											'</div>',
										'</div>',
									'</div>',
